...
public class otpactivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit = findViewById(R.id.oto_btn);
            ...
            public void onClick(View v) {
                if (otp.getText().toString().isEmpty()) {
                    ...
                    try {
                        ...
                        PhoneAuthCredential phoneAuthCredential = PhoneAuthProvider.getCredential(id, otp.getText().toString().replace(" ", ""));
                    ...
                    .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                        ...
                        public void onComplete(@NonNull Task<AuthResult> task) {
                            ...
                            if (task.isSuccessful()) {
                                ...
                                Toast.makeText(otpactivity.this, "Verification Filed", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
